...
list_of_files="txt_files/normalized_tsv_files_to_be_uploaded.txt"
...
while IFS= read -r file_path; do
    ...
    ica_path="/Normalized_TSV_Files/$file_name"
    ...
    if [[ $? != 0 ]]; then
        ...
        printf "[$time_stamp]: "
        printf "Successfully uploaded file '$file_name' to ICA path '$ica_path'. \n"
    fi
done < "$list_of_files"
