...
analysis_response=$(icav2 projectpipelines start nextflow $pipeline_id \
    ...
    --parameters output_format:fastq \
    --parameters enable_duplicate_marking:true \
    --parameters enable_variant_caller:false \
    --parameters vc_enable_vcf_output:false \
...
analysis_response_file="fastq_analysis_response.txt"
